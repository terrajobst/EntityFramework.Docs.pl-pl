...
## <a name="association-element-ssdl"></a><span data-ttu-id="9bd70-114">Element Association (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-114">Association Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="9bd70-135">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-135">Example</span></span>
...
<span data-ttu-id="9bd70-144">Element **AssociationSet** może mieć następujące elementy podrzędne (w podanej kolejności):</span><span class="sxs-lookup"><span data-stu-id="9bd70-144">The **AssociationSet** element can have the following child elements (in the order listed):</span></span>
...
## <a name="collectiontype-element-ssdl"></a><span data-ttu-id="9bd70-164">CollectionType — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-164">CollectionType Element (SSDL)</span></span>
...
## <a name="commandtext-element-ssdl"></a><span data-ttu-id="9bd70-173">CommandText — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-173">CommandText Element (SSDL)</span></span>
...
## <a name="definingquery-element-ssdl"></a><span data-ttu-id="9bd70-182">DefiningQuery — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-182">DefiningQuery Element (SSDL)</span></span>
...
## <a name="dependent-element-ssdl"></a><span data-ttu-id="9bd70-194">Element zależny (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-194">Dependent Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="9bd70-213">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-213">Example</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-223">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-223">Applicable Attributes</span></span>
...
### <a name="end-element-as-a-child-of-the-association-element"></a><span data-ttu-id="9bd70-233">End — element jako element podrzędny elementu Association</span><span class="sxs-lookup"><span data-stu-id="9bd70-233">End Element as a Child of the Association Element</span></span>
...
### <a name="end-element-as-a-child-of-the-associationset-element"></a><span data-ttu-id="9bd70-264">End — element jako element podrzędny elementu AssociationSet</span><span class="sxs-lookup"><span data-stu-id="9bd70-264">End Element as a Child of the AssociationSet Element</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-294">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-294">Applicable Attributes</span></span>
...
## <a name="entityset-element-ssdl"></a><span data-ttu-id="9bd70-309">EntitySet — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-309">EntitySet Element (SSDL)</span></span>
...
<span data-ttu-id="9bd70-347">Element **EntityType** może mieć następujące elementy podrzędne (w podanej kolejności):</span><span class="sxs-lookup"><span data-stu-id="9bd70-347">The **EntityType** element can have the following child elements (in the order listed):</span></span>
...
## <a name="function-element-ssdl"></a><span data-ttu-id="9bd70-366">Function — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-366">Function Element (SSDL)</span></span>
...
## <a name="key-element-ssdl"></a><span data-ttu-id="9bd70-424">Key — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-424">Key Element (SSDL)</span></span>
...
<span data-ttu-id="9bd70-463">W poniższej tabeli opisano atrybuty, które można zastosować do elementu **parametru** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-463">The table below describes the attributes that can be applied to the **Parameter** element.</span></span>
...
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="9bd70-467">**Nazwa**</span><span class="sxs-lookup"><span data-stu-id="9bd70-467">**Name**</span></span>       | <span data-ttu-id="9bd70-468">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-468">Yes</span></span>         | <span data-ttu-id="9bd70-469">Nazwa parametru.</span><span class="sxs-lookup"><span data-stu-id="9bd70-469">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="9bd70-470">**Typ**</span><span class="sxs-lookup"><span data-stu-id="9bd70-470">**Type**</span></span>       | <span data-ttu-id="9bd70-471">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-471">Yes</span></span>         | <span data-ttu-id="9bd70-472">Typ parametru.</span><span class="sxs-lookup"><span data-stu-id="9bd70-472">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="9bd70-473">**Wyst**</span><span class="sxs-lookup"><span data-stu-id="9bd70-473">**Mode**</span></span>       | <span data-ttu-id="9bd70-474">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-474">No</span></span>          | <span data-ttu-id="9bd70-475">**W**, **out**lub **Inout** , w zależności od tego, czy parametr jest parametrem wejściowym, wyjściowym lub wejściowym.</span><span class="sxs-lookup"><span data-stu-id="9bd70-475">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="9bd70-476">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="9bd70-476">**MaxLength**</span></span>  | <span data-ttu-id="9bd70-477">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-477">No</span></span>          | <span data-ttu-id="9bd70-478">Maksymalna długość parametru.</span><span class="sxs-lookup"><span data-stu-id="9bd70-478">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="9bd70-479">**Dokładne**</span><span class="sxs-lookup"><span data-stu-id="9bd70-479">**Precision**</span></span>  | <span data-ttu-id="9bd70-480">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-480">No</span></span>          | <span data-ttu-id="9bd70-481">Precyzja parametru.</span><span class="sxs-lookup"><span data-stu-id="9bd70-481">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="9bd70-482">**Zasięgu**</span><span class="sxs-lookup"><span data-stu-id="9bd70-482">**Scale**</span></span>      | <span data-ttu-id="9bd70-483">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-483">No</span></span>          | <span data-ttu-id="9bd70-484">Skala parametru.</span><span class="sxs-lookup"><span data-stu-id="9bd70-484">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="9bd70-485">**SRID**</span><span class="sxs-lookup"><span data-stu-id="9bd70-485">**SRID**</span></span>       | <span data-ttu-id="9bd70-486">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-486">No</span></span>          | <span data-ttu-id="9bd70-487">Identyfikator odwołania do systemu przestrzennego.</span><span class="sxs-lookup"><span data-stu-id="9bd70-487">Spatial System Reference Identifier.</span></span> <span data-ttu-id="9bd70-488">Prawidłowe tylko dla parametrów typów przestrzennych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-488">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="9bd70-489">Aby uzyskać więcej informacji, zobacz [SRID](https://en.wikipedia.org/wiki/SRID) i [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="9bd70-489">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="9bd70-490">Do elementu **Parameter** można zastosować dowolną liczbę atrybutów adnotacji (niestandardowych atrybutów XML).</span><span class="sxs-lookup"><span data-stu-id="9bd70-490">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="9bd70-491">Jednak atrybuty niestandardowe nie mogą należeć do żadnej przestrzeni nazw XML zarezerwowanej dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-491">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="9bd70-492">W pełni kwalifikowane nazwy dla wszystkich dwóch atrybutów niestandardowych nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-492">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-493">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-493">Example</span></span>

<span data-ttu-id="9bd70-494">Poniższy przykład pokazuje element **funkcji** , który ma dwa elementy **parametrów** , które określają parametry wejściowe:</span><span class="sxs-lookup"><span data-stu-id="9bd70-494">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="9bd70-495">Element podmiotu zabezpieczeń (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-495">Principal Element (SSDL)</span></span>

<span data-ttu-id="9bd70-496">Element **Principal** w języku definicji schematu magazynu (SSDL) jest elementem podrzędnym elementu ReferentialConstraint, który definiuje główne zakończenie ograniczenia klucza obcego (nazywanego również ograniczeniem referencyjnym).</span><span class="sxs-lookup"><span data-stu-id="9bd70-496">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="9bd70-497">Element **Principal** określa kolumnę klucza podstawowego (lub kolumny) w tabeli, do której odwołuje się inna kolumna (lub kolumny).</span><span class="sxs-lookup"><span data-stu-id="9bd70-497">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="9bd70-498">Elementy **PropertyRef** określają, do których kolumn odwołują się odwołania.</span><span class="sxs-lookup"><span data-stu-id="9bd70-498">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="9bd70-499">Element zależny określa kolumny, które odwołują się do kolumn klucza podstawowego, które są określone w elemencie **Principal** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-499">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="9bd70-500">Element **Principal** może mieć następujące elementy podrzędne (w podanej kolejności):</span><span class="sxs-lookup"><span data-stu-id="9bd70-500">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="9bd70-501">PropertyRef (co najmniej jeden)</span><span class="sxs-lookup"><span data-stu-id="9bd70-501">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="9bd70-502">Elementy adnotacji (zero lub więcej)</span><span class="sxs-lookup"><span data-stu-id="9bd70-502">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-503">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-503">Applicable Attributes</span></span>

<span data-ttu-id="9bd70-504">W poniższej tabeli opisano atrybuty, które można zastosować do elementu **głównego** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-504">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="9bd70-505">Nazwa atrybutu</span><span class="sxs-lookup"><span data-stu-id="9bd70-505">Attribute Name</span></span> | <span data-ttu-id="9bd70-506">Jest wymagana</span><span class="sxs-lookup"><span data-stu-id="9bd70-506">Is Required</span></span> | <span data-ttu-id="9bd70-507">Wartość</span><span class="sxs-lookup"><span data-stu-id="9bd70-507">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="9bd70-508">**Rola**</span><span class="sxs-lookup"><span data-stu-id="9bd70-508">**Role**</span></span>       | <span data-ttu-id="9bd70-509">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-509">Yes</span></span>         | <span data-ttu-id="9bd70-510">Taka sama wartość jak atrybut **roli** (jeśli jest używany) odpowiadającego elementu końcowego; w przeciwnym razie nazwa tabeli, która zawiera kolumnę, do której się odwołuje.</span><span class="sxs-lookup"><span data-stu-id="9bd70-510">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="9bd70-511">Do elementu **Principal** można zastosować dowolną liczbę atrybutów adnotacji (niestandardowych atrybutów XML).</span><span class="sxs-lookup"><span data-stu-id="9bd70-511">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="9bd70-512">Jednak atrybuty niestandardowe nie mogą należeć do żadnej przestrzeni nazw XML zarezerwowanej dla CSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-512">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="9bd70-513">W pełni kwalifikowane nazwy dla wszystkich dwóch atrybutów niestandardowych nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-513">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-514">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-514">Example</span></span>

<span data-ttu-id="9bd70-515">Poniższy przykład pokazuje element skojarzenia, który używa elementu **ReferentialConstraint** , aby określić kolumny, które uczestniczą w ograniczeniu klucza obcego **\_CustomerOrders** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-515">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="9bd70-516">Element **Principal** określa kolumnę **IDKlienta** tabeli **Customer** jako główny koniec ograniczenia.</span><span class="sxs-lookup"><span data-stu-id="9bd70-516">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="9bd70-517">Property — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-517">Property Element (SSDL)</span></span>

<span data-ttu-id="9bd70-518">Element **Property** w języku definicji schematu magazynu (SSDL) reprezentuje kolumnę w tabeli w źródłowej bazie danych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-518">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="9bd70-519">Elementy **Właściwości** są elementami podrzędnymi elementów EntityType, które reprezentują wiersze w tabeli.</span><span class="sxs-lookup"><span data-stu-id="9bd70-519">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="9bd70-520">Każdy element **Właściwości** zdefiniowany dla elementu **EntityType** reprezentuje kolumnę.</span><span class="sxs-lookup"><span data-stu-id="9bd70-520">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="9bd70-521">Element **Właściwości** nie może mieć żadnych elementów podrzędnych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-521">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-522">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-522">Applicable Attributes</span></span>

<span data-ttu-id="9bd70-523">W poniższej tabeli opisano atrybuty, które można zastosować do elementu **Właściwości** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-523">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="9bd70-524">Nazwa atrybutu</span><span class="sxs-lookup"><span data-stu-id="9bd70-524">Attribute Name</span></span>            | <span data-ttu-id="9bd70-525">Jest wymagana</span><span class="sxs-lookup"><span data-stu-id="9bd70-525">Is Required</span></span> | <span data-ttu-id="9bd70-526">Wartość</span><span class="sxs-lookup"><span data-stu-id="9bd70-526">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="9bd70-527">**Nazwa**</span><span class="sxs-lookup"><span data-stu-id="9bd70-527">**Name**</span></span>                  | <span data-ttu-id="9bd70-528">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-528">Yes</span></span>         | <span data-ttu-id="9bd70-529">Nazwa odpowiedniej kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-529">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="9bd70-530">**Typ**</span><span class="sxs-lookup"><span data-stu-id="9bd70-530">**Type**</span></span>                  | <span data-ttu-id="9bd70-531">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-531">Yes</span></span>         | <span data-ttu-id="9bd70-532">Typ odpowiadającej kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-532">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="9bd70-533">**Wymaga**</span><span class="sxs-lookup"><span data-stu-id="9bd70-533">**Nullable**</span></span>              | <span data-ttu-id="9bd70-534">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-534">No</span></span>          | <span data-ttu-id="9bd70-535">Wartość **true** (wartość domyślna) lub **Fałsz** w zależności od tego, czy odpowiadająca kolumna może mieć wartość null.</span><span class="sxs-lookup"><span data-stu-id="9bd70-535">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="9bd70-536">**DefaultValue**</span><span class="sxs-lookup"><span data-stu-id="9bd70-536">**DefaultValue**</span></span>          | <span data-ttu-id="9bd70-537">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-537">No</span></span>          | <span data-ttu-id="9bd70-538">Wartość domyślna odpowiedniej kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-538">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="9bd70-539">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="9bd70-539">**MaxLength**</span></span>             | <span data-ttu-id="9bd70-540">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-540">No</span></span>          | <span data-ttu-id="9bd70-541">Maksymalna długość odpowiedniej kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-541">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="9bd70-542">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="9bd70-542">**FixedLength**</span></span>           | <span data-ttu-id="9bd70-543">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-543">No</span></span>          | <span data-ttu-id="9bd70-544">**Prawda** lub **Fałsz** w zależności od tego, czy odpowiadająca wartość kolumny będzie przechowywana jako ciąg o stałej długości.</span><span class="sxs-lookup"><span data-stu-id="9bd70-544">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="9bd70-545">**Dokładne**</span><span class="sxs-lookup"><span data-stu-id="9bd70-545">**Precision**</span></span>             | <span data-ttu-id="9bd70-546">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-546">No</span></span>          | <span data-ttu-id="9bd70-547">Precyzja odpowiadającej kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-547">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="9bd70-548">**Zasięgu**</span><span class="sxs-lookup"><span data-stu-id="9bd70-548">**Scale**</span></span>                 | <span data-ttu-id="9bd70-549">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-549">No</span></span>          | <span data-ttu-id="9bd70-550">Skala odpowiadającej kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-550">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="9bd70-551">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="9bd70-551">**Unicode**</span></span>               | <span data-ttu-id="9bd70-552">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-552">No</span></span>          | <span data-ttu-id="9bd70-553">**Prawda** lub **Fałsz** w zależności od tego, czy odpowiadająca wartość kolumny będzie przechowywana jako ciąg Unicode.</span><span class="sxs-lookup"><span data-stu-id="9bd70-553">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="9bd70-554">**Sortowanie**</span><span class="sxs-lookup"><span data-stu-id="9bd70-554">**Collation**</span></span>             | <span data-ttu-id="9bd70-555">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-555">No</span></span>          | <span data-ttu-id="9bd70-556">Ciąg określający sekwencję sortowania, która ma być używana w źródle danych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-556">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="9bd70-557">**SRID**</span><span class="sxs-lookup"><span data-stu-id="9bd70-557">**SRID**</span></span>                  | <span data-ttu-id="9bd70-558">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-558">No</span></span>          | <span data-ttu-id="9bd70-559">Identyfikator odwołania do systemu przestrzennego.</span><span class="sxs-lookup"><span data-stu-id="9bd70-559">Spatial System Reference Identifier.</span></span> <span data-ttu-id="9bd70-560">Prawidłowe tylko dla właściwości typów przestrzennych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-560">Valid only for properties of spatial types.</span></span> <span data-ttu-id="9bd70-561">Aby uzyskać więcej informacji, zobacz [SRID](https://en.wikipedia.org/wiki/SRID) i [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="9bd70-561">For more information, see [SRID](https://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="9bd70-562">**StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="9bd70-562">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="9bd70-563">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-563">No</span></span>          | <span data-ttu-id="9bd70-564">**Brak**, **tożsamość** (jeśli odpowiadająca wartość kolumny jest tożsamością wygenerowaną w bazie danych) lub **obliczana** (jeśli odpowiadająca wartość kolumny jest obliczana w bazie danych).</span><span class="sxs-lookup"><span data-stu-id="9bd70-564">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="9bd70-565">Nieprawidłowy dla właściwości RowType.</span><span class="sxs-lookup"><span data-stu-id="9bd70-565">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="9bd70-566">Do elementu **Property** można zastosować dowolną liczbę atrybutów adnotacji (niestandardowych atrybutów XML).</span><span class="sxs-lookup"><span data-stu-id="9bd70-566">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="9bd70-567">Jednak atrybuty niestandardowe nie mogą należeć do żadnej przestrzeni nazw XML zarezerwowanej dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-567">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="9bd70-568">W pełni kwalifikowane nazwy dla wszystkich dwóch atrybutów niestandardowych nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-568">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-569">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-569">Example</span></span>

<span data-ttu-id="9bd70-570">Poniższy przykład pokazuje element **EntityType** z dwoma podrzędnymi elementami **Właściwości** :</span><span class="sxs-lookup"><span data-stu-id="9bd70-570">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="9bd70-571">PropertyRef — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-571">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="9bd70-572">Element **PropertyRef** w języku definicji schematu magazynu (SSDL) odwołuje się do właściwości zdefiniowanej w elemencie EntityType, aby wskazać, że właściwość wykona jedną z następujących ról:</span><span class="sxs-lookup"><span data-stu-id="9bd70-572">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="9bd70-573">Należy do klucza podstawowego tabeli, która reprezentuje element **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-573">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="9bd70-574">Aby zdefiniować klucz podstawowy, można użyć co najmniej jednego elementu **PropertyRef** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-574">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="9bd70-575">Aby uzyskać więcej informacji, zobacz klucz element.</span><span class="sxs-lookup"><span data-stu-id="9bd70-575">For more information, see Key element.</span></span>
-   <span data-ttu-id="9bd70-576">Być zależnym lub głównym końcem ograniczenia referencyjnego.</span><span class="sxs-lookup"><span data-stu-id="9bd70-576">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="9bd70-577">Aby uzyskać więcej informacji, zobacz ReferentialConstraint element.</span><span class="sxs-lookup"><span data-stu-id="9bd70-577">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="9bd70-578">Element **PropertyRef** może mieć tylko następujące elementy podrzędne:</span><span class="sxs-lookup"><span data-stu-id="9bd70-578">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="9bd70-579">Dokumentacja (zero lub jedna)</span><span class="sxs-lookup"><span data-stu-id="9bd70-579">Documentation (zero or one)</span></span>
-   <span data-ttu-id="9bd70-580">Elementy adnotacji</span><span class="sxs-lookup"><span data-stu-id="9bd70-580">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-581">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-581">Applicable Attributes</span></span>

<span data-ttu-id="9bd70-582">W poniższej tabeli opisano atrybuty, które można zastosować do elementu **PropertyRef** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-582">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="9bd70-583">Nazwa atrybutu</span><span class="sxs-lookup"><span data-stu-id="9bd70-583">Attribute Name</span></span> | <span data-ttu-id="9bd70-584">Jest wymagana</span><span class="sxs-lookup"><span data-stu-id="9bd70-584">Is Required</span></span> | <span data-ttu-id="9bd70-585">Wartość</span><span class="sxs-lookup"><span data-stu-id="9bd70-585">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="9bd70-586">**Nazwa**</span><span class="sxs-lookup"><span data-stu-id="9bd70-586">**Name**</span></span>       | <span data-ttu-id="9bd70-587">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-587">Yes</span></span>         | <span data-ttu-id="9bd70-588">Nazwa właściwości, której dotyczy odwołanie.</span><span class="sxs-lookup"><span data-stu-id="9bd70-588">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="9bd70-589">Do elementu **PropertyRef** można zastosować dowolną liczbę atrybutów adnotacji (niestandardowych atrybutów XML).</span><span class="sxs-lookup"><span data-stu-id="9bd70-589">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="9bd70-590">Jednak atrybuty niestandardowe nie mogą należeć do żadnej przestrzeni nazw XML zarezerwowanej dla CSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-590">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="9bd70-591">W pełni kwalifikowane nazwy dla wszystkich dwóch atrybutów niestandardowych nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-591">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-592">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-592">Example</span></span>

<span data-ttu-id="9bd70-593">Poniższy przykład przedstawia element **PropertyRef** służący do definiowania klucza podstawowego przez odwołanie do właściwości, która jest zdefiniowana dla elementu **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-593">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="9bd70-594">ReferentialConstraint — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-594">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="9bd70-595">Element **ReferentialConstraint** w języku definicji schematu magazynu (SSDL) reprezentuje ograniczenie klucza obcego (nazywane również ograniczeniem integralności referencyjnej) w źródłowej bazie danych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-595">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="9bd70-596">Podmiot zabezpieczeń i zależne zakończenia ograniczenia są określane odpowiednio przez główne i zależne elementy podrzędne.</span><span class="sxs-lookup"><span data-stu-id="9bd70-596">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="9bd70-597">Kolumny, które uczestniczą w głównej i zależnych końcach, są przywoływane z elementami PropertyRef.</span><span class="sxs-lookup"><span data-stu-id="9bd70-597">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="9bd70-598">Element **ReferentialConstraint** jest opcjonalnym elementem podrzędnym elementu Association.</span><span class="sxs-lookup"><span data-stu-id="9bd70-598">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="9bd70-599">Jeśli element **ReferentialConstraint** nie jest używany do mapowania ograniczenia FOREIGN KEY, które jest określone w elemencie **Association** , do tego celu należy użyć elementu AssociationSetMapping.</span><span class="sxs-lookup"><span data-stu-id="9bd70-599">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="9bd70-600">Element **ReferentialConstraint** może mieć następujące elementy podrzędne:</span><span class="sxs-lookup"><span data-stu-id="9bd70-600">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="9bd70-601">Dokumentacja (zero lub jedna)</span><span class="sxs-lookup"><span data-stu-id="9bd70-601">Documentation (zero or one)</span></span>
-   <span data-ttu-id="9bd70-602">Podmiot zabezpieczeń (dokładnie jeden)</span><span class="sxs-lookup"><span data-stu-id="9bd70-602">Principal (exactly one)</span></span>
-   <span data-ttu-id="9bd70-603">Zależne (dokładnie jeden)</span><span class="sxs-lookup"><span data-stu-id="9bd70-603">Dependent (exactly one)</span></span>
-   <span data-ttu-id="9bd70-604">Elementy adnotacji (zero lub więcej)</span><span class="sxs-lookup"><span data-stu-id="9bd70-604">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-605">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-605">Applicable Attributes</span></span>

<span data-ttu-id="9bd70-606">Do elementu **ReferentialConstraint** można zastosować dowolną liczbę atrybutów adnotacji (niestandardowych atrybutów XML).</span><span class="sxs-lookup"><span data-stu-id="9bd70-606">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="9bd70-607">Jednak atrybuty niestandardowe nie mogą należeć do żadnej przestrzeni nazw XML zarezerwowanej dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-607">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="9bd70-608">W pełni kwalifikowane nazwy dla wszystkich dwóch atrybutów niestandardowych nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-608">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-609">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-609">Example</span></span>

<span data-ttu-id="9bd70-610">Poniższy przykład pokazuje element **skojarzenia** , który używa elementu **ReferentialConstraint** , aby określić kolumny, które uczestniczą w ograniczeniu klucza obcego **\_CustomerOrders** :</span><span class="sxs-lookup"><span data-stu-id="9bd70-610">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="9bd70-611">ReturnType — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-611">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="9bd70-612">Element **ReturnType** w języku definicji schematu magazynu (SSDL) Określa zwracany typ dla funkcji, która jest zdefiniowana w elemencie **Function** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-612">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="9bd70-613">Typ zwracany funkcji można także określić przy użyciu atrybutu **ReturnValue** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-613">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="9bd70-614">Zwracany typ funkcji jest określany przy użyciu atrybutu **Type** lub **ReturnType** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-614">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="9bd70-615">Element **ReturnType** może mieć następujące elementy podrzędne:</span><span class="sxs-lookup"><span data-stu-id="9bd70-615">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="9bd70-616">CollectionType (jeden)</span><span class="sxs-lookup"><span data-stu-id="9bd70-616">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="9bd70-617">Dowolna liczba atrybutów adnotacji (niestandardowych atrybutów XML) może zostać zastosowana do elementu **ReturnType** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-617">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="9bd70-618">Jednak atrybuty niestandardowe nie mogą należeć do żadnej przestrzeni nazw XML zarezerwowanej dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-618">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="9bd70-619">W pełni kwalifikowane nazwy dla wszystkich dwóch atrybutów niestandardowych nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-619">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-620">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-620">Example</span></span>

<span data-ttu-id="9bd70-621">W poniższym przykładzie zastosowano **funkcję** zwracającą kolekcję wierszy.</span><span class="sxs-lookup"><span data-stu-id="9bd70-621">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="9bd70-622">RowType — element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-622">RowType Element (SSDL)</span></span>

<span data-ttu-id="9bd70-623">Element **RowType** w języku definicji schematu magazynu (SSDL) definiuje nienazwaną strukturę jako zwracany typ dla funkcji zdefiniowanej w sklepie.</span><span class="sxs-lookup"><span data-stu-id="9bd70-623">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="9bd70-624">Element **RowType** jest elementem podrzędnym elementu **CollectionType** :</span><span class="sxs-lookup"><span data-stu-id="9bd70-624">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="9bd70-625">Element **RowType** może mieć następujące elementy podrzędne:</span><span class="sxs-lookup"><span data-stu-id="9bd70-625">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="9bd70-626">Właściwość (co najmniej jedna)</span><span class="sxs-lookup"><span data-stu-id="9bd70-626">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="9bd70-627">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-627">Example</span></span>

<span data-ttu-id="9bd70-628">Poniższy przykład pokazuje funkcję magazynu, która używa elementu **CollectionType** , aby określić, że funkcja zwraca kolekcję wierszy (jak określono w elemencie **RowType** ).</span><span class="sxs-lookup"><span data-stu-id="9bd70-628">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="9bd70-629">Element schematu (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-629">Schema Element (SSDL)</span></span>

<span data-ttu-id="9bd70-630">Element **schematu** w języku definicji schematu magazynu (SSDL) jest elementem głównym definicji modelu magazynu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-630">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="9bd70-631">Zawiera definicje obiektów, funkcji i kontenerów, które tworzą model magazynu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-631">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="9bd70-632">Element **schematu** może zawierać zero lub więcej z następujących elementów podrzędnych:</span><span class="sxs-lookup"><span data-stu-id="9bd70-632">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="9bd70-633">Skojarzenie</span><span class="sxs-lookup"><span data-stu-id="9bd70-633">Association</span></span>
-   <span data-ttu-id="9bd70-634">Typ entityType</span><span class="sxs-lookup"><span data-stu-id="9bd70-634">EntityType</span></span>
-   <span data-ttu-id="9bd70-635">EntityContainer</span><span class="sxs-lookup"><span data-stu-id="9bd70-635">EntityContainer</span></span>
-   <span data-ttu-id="9bd70-636">Funkcja</span><span class="sxs-lookup"><span data-stu-id="9bd70-636">Function</span></span>

<span data-ttu-id="9bd70-637">Element **schematu** używa atrybutu **przestrzeni nazw** w celu zdefiniowania przestrzeni nazw dla obiektów typ jednostki i skojarzenie w modelu magazynu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-637">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="9bd70-638">W przestrzeni nazw żadne dwa obiekty nie mogą mieć takiej samej nazwy.</span><span class="sxs-lookup"><span data-stu-id="9bd70-638">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="9bd70-639">Przestrzeń nazw modelu magazynu różni się od przestrzeni nazw XML elementu **Schema** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-639">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="9bd70-640">Przestrzeń nazw modelu magazynu (zgodnie z definicją atrybutu **Namespace** ) jest kontenerem logicznym dla typów jednostek i typów skojarzeń.</span><span class="sxs-lookup"><span data-stu-id="9bd70-640">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="9bd70-641">Przestrzeń nazw XML (wskazywana przez atrybut **xmlns** ) elementu **schematu** jest domyślną przestrzenią nazw dla elementów podrzędnych i atrybutów elementu **Schema** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-641">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="9bd70-642">Przestrzenie nazw XML w formularzu https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (gdzie RRRR i MM reprezentują odpowiednio rok i miesiąc) są zarezerwowane dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-642">XML namespaces of the form https://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="9bd70-643">Elementy niestandardowe i atrybuty nie mogą znajdować się w przestrzeniach nazw, które mają ten formularz.</span><span class="sxs-lookup"><span data-stu-id="9bd70-643">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="9bd70-644">Odpowiednie atrybuty</span><span class="sxs-lookup"><span data-stu-id="9bd70-644">Applicable Attributes</span></span>

<span data-ttu-id="9bd70-645">W poniższej tabeli opisano atrybuty, które można zastosować do elementu **Schema** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-645">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="9bd70-646">Nazwa atrybutu</span><span class="sxs-lookup"><span data-stu-id="9bd70-646">Attribute Name</span></span>            | <span data-ttu-id="9bd70-647">Jest wymagana</span><span class="sxs-lookup"><span data-stu-id="9bd70-647">Is Required</span></span> | <span data-ttu-id="9bd70-648">Wartość</span><span class="sxs-lookup"><span data-stu-id="9bd70-648">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="9bd70-649">**Namespace**</span><span class="sxs-lookup"><span data-stu-id="9bd70-649">**Namespace**</span></span>             | <span data-ttu-id="9bd70-650">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-650">Yes</span></span>         | <span data-ttu-id="9bd70-651">Przestrzeń nazw modelu magazynu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-651">The namespace of the storage model.</span></span> <span data-ttu-id="9bd70-652">Wartość atrybutu **Namespace** służy do tworzenia w pełni kwalifikowanej nazwy typu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-652">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="9bd70-653">Na przykład jeśli obiekt **EntityType** o nazwie *Customer* znajduje się w przestrzeni nazw ExampleModel. Store, a następnie w pełni kwalifikowana nazwa **obiektu EntityType** to ExampleModel. Store. Customer.</span><span class="sxs-lookup"><span data-stu-id="9bd70-653">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="9bd70-654">Następujące ciągi nie mogą być używane jako wartość atrybutu **Namespace** : **system**, **przejściowy**lub **EDM**.</span><span class="sxs-lookup"><span data-stu-id="9bd70-654">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="9bd70-655">Wartość atrybutu **przestrzeni nazw** nie może być taka sama jak wartość atrybutu **Namespace** w elemencie schematu CSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-655">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="9bd70-656">**Alias**</span><span class="sxs-lookup"><span data-stu-id="9bd70-656">**Alias**</span></span>                 | <span data-ttu-id="9bd70-657">Nie</span><span class="sxs-lookup"><span data-stu-id="9bd70-657">No</span></span>          | <span data-ttu-id="9bd70-658">Identyfikator używany zamiast nazwy przestrzeni nazw.</span><span class="sxs-lookup"><span data-stu-id="9bd70-658">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="9bd70-659">Na przykład jeśli obiekt **EntityType** o nazwie *Customer* znajduje się w przestrzeni nazw ExampleModel. Store, a wartość atrybutu **aliasu** to *StorageModel*, można użyć StorageModel. Customer jako w pełni kwalifikowanej nazwy elementu **EntityType.**</span><span class="sxs-lookup"><span data-stu-id="9bd70-659">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="9bd70-660">**Dostawca**</span><span class="sxs-lookup"><span data-stu-id="9bd70-660">**Provider**</span></span>              | <span data-ttu-id="9bd70-661">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-661">Yes</span></span>         | <span data-ttu-id="9bd70-662">Dostawca danych.</span><span class="sxs-lookup"><span data-stu-id="9bd70-662">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="9bd70-663">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="9bd70-663">**ProviderManifestToken**</span></span> | <span data-ttu-id="9bd70-664">Tak</span><span class="sxs-lookup"><span data-stu-id="9bd70-664">Yes</span></span>         | <span data-ttu-id="9bd70-665">Token wskazujący dostawcy, który manifest dostawcy ma zwrócić.</span><span class="sxs-lookup"><span data-stu-id="9bd70-665">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="9bd70-666">Nie zdefiniowano żadnego formatu dla tokenu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-666">No format for the token is defined.</span></span> <span data-ttu-id="9bd70-667">Wartości dla tokenu są definiowane przez dostawcę.</span><span class="sxs-lookup"><span data-stu-id="9bd70-667">Values for the token are defined by the provider.</span></span> <span data-ttu-id="9bd70-668">Aby uzyskać informacje na temat tokenów manifestu dostawcy SQL Server, zobacz SqlClient dla Entity Framework.</span><span class="sxs-lookup"><span data-stu-id="9bd70-668">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="9bd70-669">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-669">Example</span></span>

<span data-ttu-id="9bd70-670">Poniższy przykład pokazuje element **schematu** , który zawiera element **EntityContainer** , dwa elementy **EntityType** i jeden element **skojarzenia** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-670">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="9bd70-671">Atrybuty adnotacji</span><span class="sxs-lookup"><span data-stu-id="9bd70-671">Annotation Attributes</span></span>

<span data-ttu-id="9bd70-672">Atrybuty adnotacji w języku definicji schematu magazynu (SSDL) to niestandardowe atrybuty XML w modelu magazynu, które zapewniają dodatkowe metadane dotyczące elementów w modelu magazynu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-672">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="9bd70-673">Oprócz posiadania prawidłowej struktury XML, następujące ograniczenia mają zastosowanie do atrybutów adnotacji:</span><span class="sxs-lookup"><span data-stu-id="9bd70-673">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="9bd70-674">Atrybuty adnotacji nie mogą znajdować się w żadnej przestrzeni nazw XML zarezerwowanej dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-674">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="9bd70-675">W pełni kwalifikowane nazwy jakichkolwiek dwóch atrybutów adnotacji nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-675">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="9bd70-676">Do danego elementu SSDL można zastosować więcej niż jeden atrybut adnotacji.</span><span class="sxs-lookup"><span data-stu-id="9bd70-676">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="9bd70-677">Do metadanych zawartych w elementach adnotacji można uzyskać dostęp w czasie wykonywania przy użyciu klas w przestrzeni nazw System. Data. Metadata. Edm.</span><span class="sxs-lookup"><span data-stu-id="9bd70-677">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-678">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-678">Example</span></span>

<span data-ttu-id="9bd70-679">Poniższy przykład pokazuje element EntityType, który ma atrybut adnotacji zastosowany do właściwości **IDZamówienia** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-679">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="9bd70-680">W przykładzie pokazano również, że element adnotacji został dodany do elementu **EntityType** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-680">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="9bd70-681">Elementy adnotacji (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-681">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="9bd70-682">Elementy adnotacji w języku definicji schematu magazynu (SSDL) to niestandardowe elementy XML w modelu magazynu, które zapewniają dodatkowe metadane dotyczące modelu magazynu.</span><span class="sxs-lookup"><span data-stu-id="9bd70-682">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="9bd70-683">Oprócz posiadania prawidłowej struktury XML, następujące ograniczenia dotyczą elementów adnotacji:</span><span class="sxs-lookup"><span data-stu-id="9bd70-683">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="9bd70-684">Elementy adnotacji nie mogą znajdować się w żadnej przestrzeni nazw XML zarezerwowanej dla SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-684">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="9bd70-685">W pełni kwalifikowane nazwy jakichkolwiek dwóch elementów adnotacji nie mogą być takie same.</span><span class="sxs-lookup"><span data-stu-id="9bd70-685">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="9bd70-686">Elementy adnotacji muszą występować po wszystkich innych elementach podrzędnych danego elementu SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-686">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="9bd70-687">Więcej niż jeden element adnotacji może być elementem podrzędnym danego elementu SSDL.</span><span class="sxs-lookup"><span data-stu-id="9bd70-687">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="9bd70-688">Począwszy od .NET Framework w wersji 4, metadane zawarte w elementach adnotacji są dostępne w czasie wykonywania przy użyciu klas w przestrzeni nazw System. Data. Metadata. Edm.</span><span class="sxs-lookup"><span data-stu-id="9bd70-688">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="9bd70-689">Przykład</span><span class="sxs-lookup"><span data-stu-id="9bd70-689">Example</span></span>

<span data-ttu-id="9bd70-690">Poniższy przykład pokazuje element EntityType, który ma element adnotacji (**CustomElement**).</span><span class="sxs-lookup"><span data-stu-id="9bd70-690">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="9bd70-691">W przykładzie przedstawiono również atrybut adnotacji zastosowany do właściwości **IDZamówienia** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-691">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="9bd70-692">Aspekty (SSDL)</span><span class="sxs-lookup"><span data-stu-id="9bd70-692">Facets (SSDL)</span></span>

<span data-ttu-id="9bd70-693">Zestawy reguł w języku definicji schematu magazynu (SSDL) przedstawiają ograniczenia dotyczące typów kolumn, które są określone w elementach właściwości.</span><span class="sxs-lookup"><span data-stu-id="9bd70-693">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="9bd70-694">Zestawy reguł są implementowane jako atrybuty XML w elementach **Właściwości** .</span><span class="sxs-lookup"><span data-stu-id="9bd70-694">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="9bd70-695">W poniższej tabeli opisano aspekty, które są obsługiwane w programie SSDL:</span><span class="sxs-lookup"><span data-stu-id="9bd70-695">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="9bd70-696">Aspekcie</span><span class="sxs-lookup"><span data-stu-id="9bd70-696">Facet</span></span>           | <span data-ttu-id="9bd70-697">Opis</span><span class="sxs-lookup"><span data-stu-id="9bd70-697">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="9bd70-698">**Sortowanie**</span><span class="sxs-lookup"><span data-stu-id="9bd70-698">**Collation**</span></span>   | <span data-ttu-id="9bd70-699">Określa sekwencję sortowania (lub sekwencję sortowania), która ma być używana podczas wykonywania operacji porównania i porządkowania na wartościach właściwości.</span><span class="sxs-lookup"><span data-stu-id="9bd70-699">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="9bd70-700">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="9bd70-700">**FixedLength**</span></span> | <span data-ttu-id="9bd70-701">Określa, czy długość wartości kolumny może się różnić.</span><span class="sxs-lookup"><span data-stu-id="9bd70-701">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="9bd70-702">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="9bd70-702">**MaxLength**</span></span>   | <span data-ttu-id="9bd70-703">Określa maksymalną długość wartości kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-703">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="9bd70-704">**Dokładne**</span><span class="sxs-lookup"><span data-stu-id="9bd70-704">**Precision**</span></span>   | <span data-ttu-id="9bd70-705">Dla właściwości typu **Decimal**określa liczbę cyfr, jaką może mieć wartość właściwości.</span><span class="sxs-lookup"><span data-stu-id="9bd70-705">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="9bd70-706">Dla właściwości typu **Time**, **DateTime**i **DateTimeOffset**określa liczbę cyfr ułamkowych części sekundy wartości kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-706">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="9bd70-707">**Zasięgu**</span><span class="sxs-lookup"><span data-stu-id="9bd70-707">**Scale**</span></span>       | <span data-ttu-id="9bd70-708">Określa liczbę cyfr z prawej strony punktu dziesiętnego dla wartości kolumny.</span><span class="sxs-lookup"><span data-stu-id="9bd70-708">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="9bd70-709">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="9bd70-709">**Unicode**</span></span>     | <span data-ttu-id="9bd70-710">Wskazuje, czy wartość kolumny jest przechowywana w formacie Unicode.</span><span class="sxs-lookup"><span data-stu-id="9bd70-710">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
