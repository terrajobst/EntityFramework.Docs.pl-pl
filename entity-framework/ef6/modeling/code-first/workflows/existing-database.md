...
## <a name="1-create-an-existing-database"></a><span data-ttu-id="b1aea-112">1. Utwórz istniejącej bazy danych</span><span class="sxs-lookup"><span data-stu-id="b1aea-112">1. Create an Existing Database</span></span>
