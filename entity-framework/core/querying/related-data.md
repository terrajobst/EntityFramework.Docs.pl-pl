...
Innym sposobem jest do jednej z właściwości nawigacji o dekoracji `[JsonIgnore]` atrybut, który powoduje, że program Json.NET, aby nie przechodzą przez tę właściwość nawigacji podczas serializowania.
